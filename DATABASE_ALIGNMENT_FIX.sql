-- =====================================================
-- DATABASE SCHEMA ALIGNMENT - ALTER STATEMENTS
-- =====================================================
-- This script contains all ALTER statements needed to align
-- the existing database schema with the application code.
-- Execute these statements in order.
--
-- Generated: January 31, 2026
-- Purpose: Update schema to support application entities
-- =====================================================
...
-- =====================================================
-- 1. ALTER TABLE: users
-- Add missing fields to support application User entity
-- =====================================================
-- These statements will silently fail if columns already exist
-- or you can wrap them in a stored procedure/script for error handling
...
-- Add missing fields to support application Kitchen entity
-- =====================================================
...
-- Add missing fields to support application MenuItem entity
-- =====================================================
...
-- Add missing created_at field (required by SQL schema)
-- =====================================================
...
-- Support for menu item categorization (used by application)
-- =====================================================
...
-- Junction table for many-to-many relationship (MenuItem to MenuLabel)
-- =====================================================
...
-- (These should already exist from schema but verifying)
-- =====================================================

-- =====================================================
-- 7. VERIFY TABLE: payments
-- Already in original schema, creating if missing
-- =====================================================
...
-- =====================================================
-- Summary of changes:
-- 1. Added missing fields to users table
-- 2. Added missing fields to kitchens table
-- 3. Added missing fields to kitchen_menu table
-- 4. Added created_at to order_items table
-- 5. Created menu_labels table
-- 6. Created menu_item_labels junction table
-- 7. Verified payments table exists
-- 8. Verified deliveries table exists
-- 9. Verified reviews table exists
-- 10. Verified search_logs table exists
--
-- Next steps:
-- 1. Create Payment, Delivery, Review entities in Java
-- 2. Update existing entities with new fields
-- 3. Create corresponding services and repositories
-- =====================================================
